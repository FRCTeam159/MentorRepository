...
namespace GazeboExporter.Robot
{
    ...
    /// </summary>
    public class CanMotor : JointedAttachment
    {
        ...
        public int CanChannel 
        {
            get
            {
                return (int)SwData.GetDouble(Path + "/canChannel");
            }
            set
            {
                SwData.SetDouble(Path + "/canChannel", value);
            }
        }
        ...
        public CanMotor(StorageModel swData, string path, Link ChildLink) : base(swData, path, ChildLink)
        {
        ...
        /// </summary>
        private static CanMotorProperties propertyEditorControl;
        ...
        {
            propertyEditorControl = new CanMotorProperties();
        }
        /// <summary>
        ...
        public override Control GetEditorControl()
        {
            if (propertyEditorControl == null)
                setupPropertyEditor();
            propertyEditorControl.setCanMotor(this);
        ...
        public override void WriteElements(ProgressLogger log, XmlWriter owner) {
            ...
            owner.WriteString("/gazebo/frc/simulator/pwm/" + CanChannel.ToString());
            owner.WriteEndElement();
        ...
        public override void WritePlugins(ProgressLogger log, XmlWriter owner)
        {
            owner.WriteStartElement("plugin"); 
            {
                ...
                owner.WriteAttributeString("filename", "libcan_motor.so");
                SDFExporter.writeSDFElement(owner, "joint", Joint.Name.Replace(" ", "_"));
                SDFExporter.writeSDFElement(owner, "topic", "/gazebo/frc/simulator/can/" + this.CanChannel.ToString());
